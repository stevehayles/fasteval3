...
Err(Error::ParseF64(String::from("4.99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999.9999"))));
    assert_eq!(
        parse_raw("3.14 + 4.9999.9999", &mut slab),
        Err(Error::ParseF64(String::from("4.9999.9999")))
    );
}
